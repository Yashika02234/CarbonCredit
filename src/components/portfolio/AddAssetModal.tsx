...
// REMOVED: const [_step, setStep] = useState(1); to fix the TS6133 error.
// The setStep(1) call at the end is unnecessary if there's no multi-step form controlled by 'step'.
...
 // Removed setStep(1) as 'step' state is no longer declared
 onClose();
};
